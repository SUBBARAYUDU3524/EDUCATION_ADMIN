...
const BTechTable = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        const degreeRef = collection(db, "BTECH");
        ...
        for (const degreeDoc of degreeSnapshot.docs) {
          ...
          for (const { semesterId, semesterName } of semesters) {
            const subjectsRef = collection(
              db,
              `BTECH/${universityId}/semesters/${semesterId}/subjects`
            );
            ...
            for (const subjectDoc of subjectsSnapshot.docs) {
              ...
              const unitsRef = collection(
                db,
                `BTECH/${universityId}/semesters/${semesterId}/subjects/${subjectId}/units`
              );
  ...
  return (
    <div>
      <h1 className="text-3xl text-center mt-10 underline">BTECH TABLE</h1>
