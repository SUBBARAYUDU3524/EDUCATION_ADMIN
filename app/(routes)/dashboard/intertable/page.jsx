      ...
      try {
        ...
        for (const yearDoc of intermediateSnapshot.docs) {
          ...
          const coursesRef = collection(
            db,
            `INTERMEDIATE/${yearDoc.id}/courses`
          );
          ...
          for (const courseDoc of coursesSnapshot.docs) {
            ...
            const subjectsRef = collection(
              db,
              `INTERMEDIATE/${yearDoc.id}/courses/${courseDoc.id}/subjects`
            );
            ...
            for (const subjectDoc of subjectsSnapshot.docs) {
              ...
              const unitsRef = collection(
                db,
                `INTERMEDIATE/${yearDoc.id}/courses/${courseDoc.id}/subjects/${subjectDoc.id}/units`
              );
