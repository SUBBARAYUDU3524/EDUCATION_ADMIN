...
const CompetitiveForm = () => {
  ...
  const collectionName = "COMPETITIVE_DATA";
  ...
  useEffect(() => {
    if (selectedSemester && selectedCourse && selectedYear && collectionName) {
  ...
  }, [selectedSemester, selectedCourse, selectedYear, collectionName]);
  ...
  const handleCourseSubmit = async (e) => {
    e.preventDefault();
    if (!collectionName || !selectedYear) {
      toast.error("Collection name or Year is missing.");
      return;
    }
  ...
  return (
    <div>
      ...
      <div className="p-6 max-w-lg mx-auto mt-10 bg-black border rounded-lg shadow-md text-white">
        ...
        {/* Year Section */}
        <h2 className="text-2xl font-bold mb-4">Add Main Topic</h2>
        ...
        {/* Course Section */}
        <h2 className="text-2xl font-bold mb-4">Add Sub Topic</h2>
